...
import { Card, Title, AreaChart, BarChart, Subtitle, Text, Metric, Flex, BarList, Bold } from "@tremor/react";
const chartdataOne = [
    {
        date: "Jan 22",
        SemiAnalysis: 2890,
    ...
    return(
        <div>
            ...
            <Card className="bg-white">
                <Title>Estadisticas visitas</Title>
                <AreaChart
                className="h-72 mt-4"
                data={chartdataOne}
                index="date"
            ...
            <Card>
                <Title>Estadisticas visitas por pais</Title>
                <BarChart
                className="mt-6"
                data={chartdataTwo}
                index="name"
            ...
            <Card className="max-w-lg">
                <Title>Visitas de las redes sociales</Title>
                <Flex className="mt-4">
                <Text>
                    <Bold>Source</Bold>
                </Text>
