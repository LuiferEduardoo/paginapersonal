            ...
            <Banner img ={item.image[0].url}>
                ...
                <section className={styles.headerContainerDescription}>
                    <span className={styles.title}>{item.name}</span>
                        <span className={`${styles.status} ${item.url_proyect ? styles.statusOnline : styles.statusOffline}`}>
                            <div className={styles.iconContainer}>
                                <span className={`${styles.icon} ${item.url_proyect ? styles.iconBackgroundOnline: styles.iconBackgroundOffline}`}></span>
                                    <i className="fas fa-check"></i>
                            </div>{item.url_proyect ? <p>En linea</p> : <p>Fuera de linea</p>}
                        </span>
                        {item.url_proyect ?
                        <div className={styles.link}>
                            <a href={item.url_repository} target="_blank">
                            ...
                            <a href={item.url_proyect} target="_blank">
